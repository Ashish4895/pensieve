...
# In-memory: chat WS is ping-only on a single uvicorn process. RedisChannelLayer
# brpop + short socket timeouts was dropping sockets (navbar stuck on Connecting…).
CHANNEL_LAYERS = {
    "default": {
